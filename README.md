...
- **Yetenekler (Skills)**: Frontend, Backend, Makine Öğrenimi ve Araçlar olmak üzere 4 kategoride toplanmış, seviye göstergeli (1-5/5) ve animasyonlu yetenek barları (React, TS, Node, Colab vb.).
- **Projeler (Projects)**:
